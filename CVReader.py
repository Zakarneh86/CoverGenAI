...
class CVReader:
    ...
    def loadCoverLetter(self, coverLetter, userName="Your Name", usereMail="Yor Email",userPhone = "Your Phone Number", companyName = 'Company Name', jobTitle = 'Job Title' ):
        try:
            ...
            page.insert_textbox(
                pymupdf.Rect(19, 25, left_bar_width - 5, 125),
                userName,
            ...
            page.insert_textbox(
                pymupdf.Rect(19, 130, left_bar_width - 5, 200),
                usereMail,
            ...
            page.insert_textbox(
            pymupdf.Rect(19, 205, left_bar_width - 5, 275),
            userPhone,
            fontsize=20,  # Slightly smaller title
            fontname=sideFontName,
            color=(1, 1, 1),  # White text
            ...
            page.insert_textbox(
            pymupdf.Rect(left_bar_width + 18, 19, a4_width - 20, 50),
            formatted_date,
            ...
            page.insert_textbox(
                pymupdf.Rect(left_bar_width + 18, 60, a4_width - 20, 80),
                companyName,
                fontname=bodyFontName,
                fontsize=bodyFontSize,
                color=(0, 0, 0),  # Black text
            ...
            text = f'''Re: {jobTitle}'''
            page.insert_textbox(
                pymupdf.Rect(left_bar_width + 18, 90, a4_width - 20, 110),
                text,
                fontname=bodyFontName,
                fontsize=bodyFontSize,
                color=(0, 0, 0),  # Black text
